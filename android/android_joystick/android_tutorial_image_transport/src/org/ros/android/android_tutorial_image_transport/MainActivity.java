    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        go_button.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) state.setMessage("go" + count);
                else if (event.getAction() == MotionEvent.ACTION_UP) state.setMessage("stop");
                return false;
            }
        });
        ...
        back_button.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) state.setMessage("back" + count);
                else if (event.getAction() == MotionEvent.ACTION_UP) state.setMessage("stop");
                return false;
            }
        });
